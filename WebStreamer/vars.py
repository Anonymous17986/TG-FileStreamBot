...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("API_ID", "27463955"))
    API_HASH = str(environ.get("API_HASH", "14d22fb50e1581a5dab2644aff60806e"))
    BOT_TOKEN = str(environ.get("BOT_TOKEN", "6230153536:AAHua_9TC0C2Du4lD5doyMvIoynj-KV6_OE"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("BIN_CHANNEL", "-1001953595001"))
     # you NEED to use a CHANNEL when you're using MULTI_CLIENT
    PORT = int(environ.get("PORT", 8080))
    BIND_ADDRESS = str(environ.get("WEB_SERVER_BIND_ADDRESS", "34.230.4.214"))
